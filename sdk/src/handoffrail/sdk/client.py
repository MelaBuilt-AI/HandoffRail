...
class HandoffRailClient:
    ...
    def create_schema(self, *, name: str, json_schema: dict[str, Any], version: int = 1) -> SchemaResponse:
        ...
        data = self._request("POST", "/schemas", json_data=payload.to_dict())
    ...
    def list_schemas(
        ...
        *,
        ...
        """
        params: dict[str, Any] = {"limit": limit, "offset": offset}
        data = self._request("GET", "/schemas", params=params)
    ...
    def get_schema(self, schema_id: str) -> SchemaResponse:
        ...
        Returns:
            The schema response.
        """
        data = self._request("GET", f"/schemas/{schema_id}")
        return SchemaResponse.from_dict(data)

    # ── API Keys ───────────────────────────────────────────────────────────────

    def create_api_key(self, *, name: str, tenant_id: str | None = None, role: str = "admin") -> ApiKeyResponse:
